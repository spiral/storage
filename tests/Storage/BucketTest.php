...
abstract class BucketTest extends BaseTest
{
    ...
    public function testStreamIntegrity()
    {
        ...
        $stream = $bucket->getStream('target');
    ...
    public function testRename()
    {
        ...
        $stream = $bucket->getStream('targetB');
        $this->assertInstanceOf(StreamInterface::class, $stream);
    ...
    public function testRenameLongName()
    {
        ...
        $stream = $bucket->getStream('targetDir/targetName');
        $this->assertInstanceOf(StreamInterface::class, $stream);
    ...
    {
        $s = m::mock(ServerInterface::class);
        $s->expects('getStream')->andThrows(ServerException::class);
